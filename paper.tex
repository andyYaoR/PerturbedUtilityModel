...
\citep[Lemma~3.1]{wright1996superlinear}; this is the global progress guarantee.
...
\citet[Lemma~3.1]{wright1996superlinear}, and global convergence follows from
\citet[Theorem~1]{ralph2000superlinear}. Under strict complementarity, local
superlinear convergence follows from \citet[Theorem~2]{ralph2000superlinear}, which
does not require the active-constraint Jacobian to have full rank.
\end{proof}
